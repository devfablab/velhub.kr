  ...
  const paymentHistory = result.payments.flatMap((payment) => {
    ...
    const paymentHistoryItem = {
      ...
      historyDetail: {
        ...
        canRequestMinorCancellation: isRefunded ? false : payment.detail.canRequestMinorCancellation,
        canForceRefundForTest: isRefunded ? false : payment.detail.canForceRefundForTest,
    ...
    return [
      {
        ...
        historyDetail: {
          ...payment.detail,
          canRequestMinorCancellation: false,
          canForceRefundForTest: false,
          historyKind: 'refund',
        } satisfies BillingPopupDetail,
      },
      paymentHistoryItem,

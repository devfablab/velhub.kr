...
export default function Opt() {
  ...
  function handleMoveToEdit() {
    router.push(`/${siteName}/manage/contents/posts/c/${boardName}/${contentId}/edit`);
  }

  function handleMoveToList() {
    router.push(`/${siteName}/manage/contents/posts/c/${boardName}`);
  }
  ...
  async function handleDelete() {
    ...
    try {
      ...
      router.replace(`/${siteName}/manage/contents/posts/c/${boardName}`);
    } catch (unknownError) {
      if (unknownError instanceof Error) {

              ...
              <AccordionDetails>
                <Stack gap={3}>
                  ...
                  <Stack gap={1}>
                    ...
                    <Typography variant="body2">
                      3. 공포심이나 불안감을 유발하는 부호 · 문언 · 음향 · 화상 또는 영상을 반복적으로 상대방에게
                      도달하도록 하는 내용의 정보
                    </Typography>
                    <Typography variant="body2">
                    ...
                    <Typography variant="body2">
                      6-3. 총포 · 화약류(생명 · 신체에 위해를 끼칠 수 있는 폭발력을 가진 물건을 포함한다)를 제조할 수
                      있는 방법이나 설계도 등의 정보
                    </Typography>
                    <Typography variant="body2">
              ...
              <AccordionDetails>
                <Stack gap={3}>
                  ...
                  <Stack gap={1}>
                    ...
                    <Typography variant="body2">
                      아동 · 청소년 또는 아동 · 청소년으로 명백하게 인식될 수 있는 사람이나 표현물이 등장하여 성교 등
                      성적 행위(아동 · 청소년의 신체의 전부 또는 일부를 접촉 · 노출하는 행위로서 일반인의 성적
                      수치심이나 혐오감을 일으키는 행위도 포함)를 하는 내용이 표현된 것
                    </Typography>
                  </Stack>
                  <Typography variant="body2">
